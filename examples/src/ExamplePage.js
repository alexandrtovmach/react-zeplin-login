      ...
      <div className="viewport">
        <Segment basic>
          <Container text>
            <Header as='h2'>
              react-zeplin-login
              <Label basic size="mini" as='a' href="https://github.com/alexandrtovmach/react-zeplin-login">
                <Icon name='github' />GitHub
              </Label>
              <Label basic size="mini" as='a' href="https://www.npmjs.com/package/react-zeplin-login">
                <Icon name='npm' />NPM
              </Label>
            </Header>
            
            <p>
              React component for easy login to Zeplin services using OAuth technology without backend.
            </p>
            <Segment>
              <Form>
                <Form.Field>
